            ...
            'normal':
             ...
             'diff':
                 {'q_1': ['Дебют в шахматах, начинающиеся ходами королевской пешки из е4 в е6', 'Францущская защита', 'Коготь бобра', 'Скандинавская защита', 'Дебют Нимцовича', 1],
                  ...
                  'q_5': ['"Сила тока в проводнике(участке цепи) прямо пропорциональна приложенному напряжению/n и обратно пропорциональна сопротивлению проводника" это закон..', 'Ньютога', 'Ома', 'Ампера', 'Паскаля', 2],
                  'q_6': ['Первые три цифры в номере телефона называются...', 'Код страны', 'Код региона', 'Код оператора', 'Код телефона', 2],
                  'q_7': ['Как называется фаза игры в покере, когда раздаётся первые три карты/n и как называется фаза, когда ложат 5 открытую карту', 'Префлоп и флоп', 'Префлоп и ривер', 'Флоп и ривер', 'Флоп и блайнд', 3],
